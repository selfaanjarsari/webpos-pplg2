      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?= $main_url ?>customer/data_customer.php">Home</a></li>
      ...
      <div class="card">
        ...
        <div class="card-header">
          ...
          <div class="card-tools">
            <a href="<?= $main_url ?>customer/add_customer.php" class="btn btn-primary btn-sm float-right"><i class="fas fa-plus fa-sm"></i> Add Customer</a>
          </div>
        </div>
